...
namespace HandleExceptionsSolution
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var a = ParseToInt(_coefficientWithValue[CoefficientA]);
            var b = ParseToInt(_coefficientWithValue[CoefficientB]);
            var c = ParseToInt(_coefficientWithValue[CoefficientC]);
        ...
        private static bool CheckInputCoefficients(IDictionary dictionary)
        {
            ...
            foreach (var pair in dict)
            {
                try
                {
                    var number = ParseToInt(pair.Value);
                }
